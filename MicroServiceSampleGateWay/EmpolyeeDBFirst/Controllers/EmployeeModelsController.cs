...
namespace EmpolyeeDBFirst.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class EmployeeModelsController : ControllerBase
    {
        private readonly EmpolyeeDBFirstContext _context;

        public EmployeeModelsController(EmpolyeeDBFirstContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EmployeeModel>> PostEmployeeModel(EmployeeModel employeeModel)
        {
          if (_context.EmployeeModel == null)
          {
              return Problem("Entity set 'EmpolyeeDBFirstContext.EmployeeModel'  is null.");
          }
        ...
        {
            return (_context.EmployeeModel?.Any(e => e.EmployeeId == id)).GetValueOrDefault();
        }
    }
}
